...
exports.newCommentHe = (args) => {
  ...
  <body bgcolor="#FFFFFF" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" direction="rtl">
  ...
  <!-- BODY -->
  <table class="body-wrap" bgcolor="" direction="rtl">
    <tr>
      <td></td>
      <td class="container" align="" bgcolor="#FFFFFF">
          ...
          <table>
            <tr>
              <td>
                ...
                <h2>מישהו הגיב על משימה שאתה מאזין לה</h2>
              </td>
            </tr>
          </table>
        </div><!-- /content -->
        ...
        <div class="content">
          ...
          <table bgcolor="">
            <tr>
              <td class="small" width="20%" style="vertical-align: top; padding-left:10px;"><img src="${fromPhotoUrl}" /></td>
              <td>
                        ...
                        <table bgcolor="" cellpadding="" align="left">
                          <tr>
                            <td>
                              ...
                              <h5 class="">צריך תמיכה?</h5>
                              אימייל: <strong><a href="emailto:support@doocrate.com">support@doocrate.com</a></strong></p>
