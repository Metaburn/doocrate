...
const AboutPage = () => {
  return (
    <div className="g-row sign-in">
      <div className="g-col">
        <h1>מה זה?</h1>
        <span>מערכת הדואוקרט מאפשרת לנו להתארגן בצורה שטוחה תחת ארוע מסויים ולנהל את המשימות לעצמנו
        </span>
        <br /><br />
        <h1>למה?</h1>
        ...
        <span>אנחנו חלק מקולקטיב בשם מטהברן ששם לו למטרה לייצר כלים פשוטים לניהול קהילות יצירה משותפת
          <br/>
          פיתחנו את <a href='http://dreams.burnerot.com/'>מערכת החלומות</a> עבור מידברנרות ועבור ברנים אחרים
          <br/>
