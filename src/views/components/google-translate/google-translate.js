...
class GoogleTranslate extends Component {
  ...
  untranslate() {
    ...
    if (selectedLanguage[0].text.indexOf('Select') !== -1) {
      //Means it is set on Select Language
      return;
    }
  ...
  clickOnEnglish() {
    ...
    if (languagesIFrame && languagesIFrame.length > 0) {
      ...
      const enLang = Array.prototype.filter.call(languages, lang => {
